...
class ResumesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post resumes_url, params: { resume: { email: @resume.email, name: @resume.name, phone: @resume.phone } }
    end
  ...
  test "should update resume" do
    patch resume_url(@resume), params: { resume: { email: @resume.email, name: @resume.name, phone: @resume.phone } }
